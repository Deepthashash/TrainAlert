...
class CustomCard extends StatelessWidget {
  ...
  CustomCard({@required this.title, @required this.subTitle, @required this.direction, @required this.image}) : assert(title != null && direction != null && subTitle != null && image != null);

  @override
  Widget build(final BuildContext context) {
    return Container(
      margin: (direction=='left') ? EdgeInsets.only(bottom:10.0 ,left: 40.0,right: 10.0,top: 10.0) : EdgeInsets.only(bottom:10.0 ,left: 10.0,right: 40.0,top: 10.0),
      height: 200.0,
      child: Card(
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(subTitle, style: TextStyle(color: Colors.grey,), textAlign: TextAlign.center,),
            )
          ],
        ),
      ),
